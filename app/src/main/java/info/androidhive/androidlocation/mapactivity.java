...
public class mapactivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private DatabaseReference Collect_Data = mDatabase.getReference().child("clusterred_OP");


   //private FirebaseDatabase mDatabase = FirebaseDatabase.getInstance();
   //private DatabaseReference Collect_Data = mDatabase.getReference("https://androidlocation-cdecd.firebaseio.com/clusterred_OP");
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        Log.i("Test", "Entered Map Ready");
        LatLng point = new LatLng(currentlocation.getLatitude(), currentlocation.getLongitude());
        LatLng wf = new LatLng(13.035, 77.58);
        double v1=activity2.val1;
        double v2=activity2.val2;
        LatLng nearpoint=new LatLng(v1,v2);
        //mMap.animateCamera(CameraUpdateFactory.newLatLng(point));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(point, 15));
        MarkerOptions options=new MarkerOptions().position(point).title("current location");
        options.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED));
        mMap.addMarker(options);
       MarkerOptions option=new MarkerOptions().position(wf).title("near location");
